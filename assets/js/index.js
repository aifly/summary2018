...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsMusicIndex = __webpack_require__(19);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "E:\\project\\summary2018\\components\\index\\index.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 								</div>
	// 								<div ref='banners'>
	// 									<ul :style="{width:item.bannerList.length<=1?'9rem':item.bannerList.length*3.2+'rem'}">
	// 										<li v-for="(banner,k) in item.bannerList" :key="k" :style="{width:item.bannerList.length<=1?'9rem':'3rem'}">
	...
	var _libFace = __webpack_require__(17);

	var _libFace2 = _interopRequireDefault(_libFace);
	...
	exports['default'] = {
		...
		methods: {
			...
			showFrame: function showFrame(href, type) {
				if (type) {
			...
			like: function like(index, item) {
				...
				this.t = setInterval(function () {
					_this.dataList[index].faces.forEach(function (face) {
						face.animate();
					});
				}, 30);
				setTimeout((function () {
		...
		mounted: function mounted() {
			...
			setTimeout(function () {
				...
				_this2.dataList.forEach(function (data, j) {
					for (var i = 0; i < 15; i++) {
						data.faces[i] = new _libFace2['default']({ obj: _this2.$refs['face'][j * 15 + i] });
					}
				});
				_this2.scorll = new _iscroll2['default'](_this2.$refs['page'], {
			...
			setTimeout(function () {
				...
				_this2.$refs['banners'].forEach(function (banner, i) {
					if (_this2.dataList[i].bannerList.length > 1) {
						new _iscroll2['default'](banner, {
							scrollX: true,
							preventDefault: false
						});
					}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0;\r\n}\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis;\r\n}\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1223000 !important;\r\n  right: .5rem;\r\n  top: .5rem;\r\n}\r\n\r\n.zmiti-play.rotate {\r\n  -webkit-animation: rotate 5s linear infinite;\r\n  animation: rotate 5s linear infinite;\r\n}\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg);\r\n  }\r\n}\r\n\r\n.zmiti-index-main-ui {\r\n  overflow: hidden;\r\n  width: 10rem;\r\n  left: 0;\r\n  z-index: 80;\r\n}\r\n\r\n.zmiti-index-main-ui.index-enter-active, .zmiti-index-main-ui.index-leave-active {\r\n  -webkit-transition: 1s;\r\n  transition: 1s;\r\n}\r\n\r\n.zmiti-index-main-ui.index-enter, .zmiti-index-main-ui.index-leave-to {\r\n  opacity: 0;\r\n}\r\n\r\n.zmiti-index-main-ui.show {\r\n  opacity: 1;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-face {\r\n  position: absolute;\r\n  right: 0;\r\n  top: 0;\r\n  opacity: 0;\r\n  z-index: 120;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list {\r\n  width: 10rem;\r\n  margin: 0 auto;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-list-item {\r\n  position: relative;\r\n  margin: 0 0 1rem 0;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-list-item:before {\r\n  content: \"\";\r\n  position: absolute;\r\n  width: 10rem;\r\n  border-bottom: 16px solid #eaeaea;\r\n  bottom: -30px;\r\n  left: 0;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-data-like-comment {\r\n  display: -webkit-box;\r\n  -webkit-box-align: center;\r\n  -webkit-box-pack: center;\r\n  -webkit-box-orient: horizontal;\r\n  -webkit-box-pack: start;\r\n  height: 1.5rem;\r\n  line-height: 1.5rem;\r\n  width: 9.2rem;\r\n  margin: 0 auto;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-data-like-comment.zmiti-single > div:nth-of-type(2):before {\r\n  content: \"\";\r\n  display: none;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-data-like-comment > div {\r\n  margin-right: 1rem;\r\n  position: relative;\r\n  color: #666;\r\n  font-size: .4rem;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-data-like-comment > div:nth-of-type(2):before {\r\n  content: \"\";\r\n  width: 1rem;\r\n  height: 1rem;\r\n  position: absolute;\r\n  -webkit-transform: rotate(45deg);\r\n  transform: rotate(45deg);\r\n  background: #eaeaea;\r\n  left: -.2rem;\r\n  top: 92%;\r\n  z-index: -1;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-data-like-comment img {\r\n  width: .6rem;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-comment-list {\r\n  width: 8.6rem;\r\n  margin: 0 auto;\r\n  background: #eaeaea;\r\n  padding: .4rem;\r\n  border-radius: 4px;\r\n  position: relative;\r\n  font-size: .4rem;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-comment-list:before {\r\n  content: \"\";\r\n  width: 50px;\r\n  height: 50px;\r\n  position: absolute;\r\n  -webkit-transform: rotate(45deg);\r\n  transform: rotate(45deg);\r\n  display: none;\r\n  opacity: 0;\r\n  background: #eaeaea;\r\n  border-radius: 2px;\r\n  left: 164px;\r\n  top: -6px;\r\n  z-index: -1;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-comment-list > div {\r\n  display: -webkit-box;\r\n  -webkit-box-align: center;\r\n  -webkit-box-pack: center;\r\n  -webkit-box-orient: horizontal;\r\n  -webkit-box-align: start;\r\n  margin: 0 0 10px 0;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-comment-list > div > div:nth-of-type(2) {\r\n  -webkit-box-flex: 1;\r\n  color: #999;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-comment-list > div > div:nth-of-type(1) {\r\n  color: #113e99;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-item-date {\r\n  text-align: center;\r\n  color: #113e99;\r\n  margin: .5rem auto .3rem;\r\n  padding-top: .5rem;\r\n  display: -webkit-box;\r\n  -webkit-box-align: center;\r\n  -webkit-box-pack: center;\r\n  -webkit-box-orient: horizontal;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-item-date > div:nth-of-type(2) {\r\n  margin: 0 10px;\r\n  font-size: .5rem;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-item-date > div:nth-of-type(2) span {\r\n  font-size: .3rem;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-item-date > div:nth-of-type(1), .zmiti-index-main-ui .zmiti-data-list .zmiti-item-date > div:nth-of-type(3) {\r\n  position: relative;\r\n  width: 1.3rem;\r\n  height: 3px;\r\n  background: #113e99;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-item-date > div:nth-of-type(1):before, .zmiti-index-main-ui .zmiti-data-list .zmiti-item-date > div:nth-of-type(3):before {\r\n  content: '';\r\n  position: absolute;\r\n  width: .1rem;\r\n  height: .1rem;\r\n  border-radius: 50%;\r\n  border: 1px solid #113e99;\r\n  right: -2px;\r\n  top: -.04rem;\r\n  background: #fff;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-item-date > div:nth-of-type(3):before {\r\n  content: \"\";\r\n  left: -2px;\r\n  right: auto;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list {\r\n  overflow: hidden;\r\n  width: 9rem;\r\n  margin: 0 auto;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list .zmiti-subimg {\r\n  margin-bottom: 10px;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list img {\r\n  width: 100%;\r\n  height: auto;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list ul {\r\n  display: -webkit-box;\r\n  -webkit-box-align: center;\r\n  -webkit-box-pack: center;\r\n  -webkit-box-orient: horizontal;\r\n  -webkit-box-pack: justify;\r\n  -webkit-box-align: start;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list li {\r\n  width: 400px;\r\n  position: relative;\r\n  overflow: hidden;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list li .zmiti-banner-item-mask {\r\n  position: relative;\r\n  font-size: .4rem;\r\n  color: #333;\r\n  margin-top: .2rem;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list li a {\r\n  display: block;\r\n  position: relative;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-data-list .zmiti-banner-list li .zmiti-banner-item-content {\r\n  position: absolute;\r\n  width: 100%;\r\n  height: 80px;\r\n  text-indent: 10px;\r\n  line-height: 80px;\r\n  background: rgba(0, 0, 0, 0.6);\r\n  left: 0;\r\n  bottom: 0;\r\n  color: #fff;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-copyright {\r\n  background: #005192;\r\n  font-size: 44px;\r\n  color: #fff;\r\n  text-align: center;\r\n  height: 1.3rem;\r\n  line-height: 1.3rem;\r\n  position: absolute;\r\n  bottom: 0;\r\n  width: 100%;\r\n}\r\n\r\n.zmiti-index-main-ui .zmiti-logo {\r\n  position: absolute;\r\n  width: 60px;\r\n  bottom: 40px;\r\n  left: 70px;\r\n  z-index: 100;\r\n}\r\n\r\n@-webkit-keyframes shake {\r\n  to {\r\n    -webkit-transform: translate3d(0, -10px, 0) scale(0.99);\r\n    transform: translate3d(0, -10px, 0) scale(0.99);\r\n  }\r\n}\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\summary2018\\components\\music\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\summary2018\\components\\main\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _toastToastVue = __webpack_require__(26);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0;\r\n}\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis;\r\n}\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1223000 !important;\r\n  right: .5rem;\r\n  top: .5rem;\r\n}\r\n\r\n.zmiti-play.rotate {\r\n  -webkit-animation: rotate 5s linear infinite;\r\n  animation: rotate 5s linear infinite;\r\n}\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg);\r\n  }\r\n}\r\n\r\nhtml, body {\r\n  width: 10rem;\r\n}\r\n\r\n.zmiti-main-ui {\r\n  width: 10rem !important;\r\n  left: 0;\r\n  top: 0;\r\n  overflow: hidden;\r\n  background: #f01;\r\n  display: -webkit-box;\r\n  -webkit-box-align: center;\r\n  -webkit-box-pack: center;\r\n  -webkit-box-orient: horizontal;\r\n  z-index: -1;\r\n  opacity: 0;\r\n}\r\n\r\n.zmiti-main-ui.android {\r\n  position: fixed !important;\r\n}\r\n\r\n.zmiti-main-ui.show {\r\n  z-index: 90;\r\n  opacity: 1;\r\n}\r\n\r\n.zmiti-main-ui .zmiti-frame-C {\r\n  -webkit-overflow-scrolling: touch;\r\n  overflow-y: auto;\r\n  overflow-x: hidden;\r\n  height: 100vh !important;\r\n  z-index: 9999002;\r\n  width: 10rem !important;\r\n  background: #fff;\r\n}\r\n\r\n.zmiti-main-ui .zmiti-frame-C iframe {\r\n  width: 10rem;\r\n  border: 1px solid transparent;\r\n  box-sizing: border-box;\r\n  left: 0;\r\n  top: 0;\r\n  position: relative;\r\n  overflow: hidden;\r\n  height: 100vh;\r\n  padding: 0;\r\n  margin: 0;\r\n}\r\n\r\n.zmiti-main-ui .zmiti-frame-C .zmiti-back {\r\n  position: fixed;\r\n  z-index: 1001;\r\n  left: 8.5rem;\r\n  bottom: .5rem;\r\n  width: 1.4rem;\r\n  height: 1.4rem;\r\n}\r\n\r\n@-webkit-keyframes info {\r\n  from {\r\n    -webkit-transform: translate3d(0, -30px, 0);\r\n  }\r\n  to {\r\n    -webkit-transform: translate3d(0, 0, 0);\r\n  }\r\n}\r\n\r\n@-webkit-keyframes waiting {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n  }\r\n}\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\summary2018\\components\\toast\\toast.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7df85dee&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7df85dee&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
